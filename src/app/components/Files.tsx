...
const FileComponent = ({data}:any)=>{
    ...
    return(
        <Box sx={{
            ...
            <Box sx={{width:150, height:180, border:"solid", borderRadius:2, borderWidth:1, borderColor:"#3333", position:'relative'}}>
            ...
            <Box sx={{ display:"flex", flex:1, flexDirection:'column',}}> 
                ...
                <Box sx={{display:'flex', alignItems:'center', gap:1}}>
                        <Box sx={{border:"1px solid rgb(255, 203, 203)", borderRadius:"4px", backgroundColor:"rgb(255, 203, 203)", color:"rgb(207, 66, 65)", p:"5px 10px 5px 10px", fontSize:14, fontWeight:600}}>
                            {data.answerDate}
                        </Box>
